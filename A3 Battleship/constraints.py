...
num of unaccompied + num assigned
...
# use row, col and diagonals
# scope -> variables in the row/col, keep number of upper and lower bound == row const
# n values diagonal constraint fill out the adjacent pieces with water
# ships -> edge and middle piece, surrounded by water (if-then and ifallthen one)
    # do it for every pair and thriple
...
class IfAllThenOneConstraint(Constraint):
    ...
    # implement check and has support
